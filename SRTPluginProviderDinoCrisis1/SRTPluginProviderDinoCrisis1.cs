...
{
    public class SRTPluginProviderDinoCrisis1 : IPluginProvider
    {
        private Process process;
        private GameMemoryDC1CScanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryDC1CScanner(process);
            return 0;
        }
